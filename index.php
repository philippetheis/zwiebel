...
<html>
		...
		<?php
			...
			function apply_config() {
				...
				if($sponion_pw1 === $sponion_pw2){
					...
					$error_nachricht="WLAN-Passwoerter zwiebel stimmen nicht &uuml;berein";
					return false;
				}
				...
				//      } elseif($dhcp == "manuell"){
				//        hinzufuegen ip wlan0 zwiebel adresse und gateway???
				//     } else{
			...
			//SOLL: eigene Adresse des zwiebel im zwiebel-WLAN, AP-IP; soll wert
			...
			//Ist-Werte der Adresse des zwiebel im zwiebel-WLAN,
	...
	<body onload="show_messages(<?php $apply_nachricht;echo $error_nachricht ?>)">
		...
		<img src="zwiebel.png" alt="zwiebel Logo"> Version <?php echo $version ?>
		...
		<p>ACHTUNG: Sobald sie ihren Internetverkehr zur Anonymiserung
			...
			erreichbar.<br /> Bitte starten Sie ihren zwiebel dann ueber das Stromkabel
		...
		<form action="index.php" method="post">
			<table id="table">
				...
				<tr>
					<td class="category"><h5>zwiebel als Client</h5></td>
					<td class="info">Mit welchem fremden WLAN soll sich der zwiebel verbinden?</td>
		...
		<!--	<tr>
	  				<td>&nbsp;</td>
          			<td class="info">Wie soll der zwiebel seine IP-Adresse erhalten?<br /> dhcp (automatisch) ist h&auml;ufig ausreichend.</td>
	  				<td class="status">
        ...
        -->
				...
				<tr>
					<td class="category">&nbsp;</td>
					<td class="info">IP-Adresse des zwiebel am fremden Router <!-- wlan0 --></td>
					<td class="status">
				...
				<tr>
					<td class="category"><h5>zwiebel als Zugangspunkt</h5></td>
					<td class="info">Wie soll das vom zwiebel erzeugte WLAN
						hei&szlig;en?</td>
				...
				<tr>
					<td class="category">&nbsp;</td>
					<td class="info">IP-Adresse des zwiebel-Routers im eigenen
						WLAN (zwiebel.local):</td>
			...
			<!--
				<tr>
	  				<td class="category">&nbsp;</td>
	  				<td class="info">Auf welchem Frequenz-Kanal soll der zwiebel sein WLAN aufbauen?<br /> (channel)</td>
	  				<td class="status"><input type="textfield" size="20" id="hostapd_channel"value="<?php echo $hostapd_channel ?>" ></td>
				</tr>-->
			<!--
				<tr>
	  				<td class="category">&nbsp;</td>
          			<td class="info">Welcher WLAN-Stick soll der zwiebel f&uuml;r den WLAN-Zugangspunkt nutzen?<br /> (interface) </td>
			...
			-->
				<tr class="pw">
					...
					<td class="info">Wie soll das Kennwort f&uuml;r das
						zwiebel-WLAN lauten?<br />mind. 8 Zeichen!, voreingestellt: <span
			...
			<!--<tr>
					...
					<td class="info">L&auml;uft die Tor-Software auf dem zwiebel?<br /> das heiSSt allein nocht NICHT, dass der Verkehr sicher umgeleitet wird</td>
        	...
        	-->
				...
				<!--<tr>
	 				...
	 				<td class="info">Internetverkehr &uuml;ber den zwiebel-Router leiten?r</td>
